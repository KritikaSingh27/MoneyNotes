...
[![Tech Stack](https://skillicons.dev/icons?i=react,vite,django,mysql,vercel,render,git,py)](https://skillicons.dev)

This is my **first Full-stack project** where I worked on backend, frontend, database, AI integration, and deployment.
